<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminPage.aspx.cs" Inherits="ACMEINC.Admin.AdminPage" %>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownAddCategory" runat="server"
                    ItemType="ACMEINC.Models.Category"
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="DropDownRemoveProduct" runat="server"
                    ItemType="ACMEINC.Models.Product"
