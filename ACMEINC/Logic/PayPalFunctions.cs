...
namespace ACMEINC.Logic
{
    public class NVPAPICaller
    {
        ...
        public string APIUsername = "grant.verheul-facilitator_api1.gmail.com";
        private string APIPassword = "UU3KUUFXQZURZPFV";
        private string APISignature = "ADYg4IhM8kyXnCNlHP8mz1c.Bl0FAiNadHz5vlY95lU0RTQZ57WOfw-8";
...
decoder, ref string retMsg)
        ...
        public string HttpCall(string NvpRequest)
        {
           ...
           // ServicePointManager.SecurityProtocol = SecurityProtocolType.Tls12;//
            ...
            {
                // Log the exception.
                ACMEINC.Logic.ExceptionUtility.LogException(e, "HttpCall in PayPalFunction.cs");
            }
